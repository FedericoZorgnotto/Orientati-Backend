...
@update_router.get("/", response_model=UpdateList, summary="Lista aggiornamenti")
async def get_all_updates(_=Depends(admin_access)):
    return updates.get_all_updates()


@update_router.post("/", summary="Crea aggiornamento")
...
@update_router.delete("/{update_id}", response_model=UpdateList, summary="Elimina aggiornamento")
...
@update_router.put("/{update_id}", response_model=UpdateList, summary="Aggiorna aggiornamento")
...
@update_router.get("/check_new_updates", response_model=bool, summary="Controlla aggiornamenti")
async def check_new_updates(_=Depends(admin_access)):
    return updates.check_new_updates()


@update_router.get("/check_new_update/{update_id}", response_model=bool, summary="Controlla aggiornamento")
async def check_new_update(update_id: str, _=Depends(admin_access)):
    return updates.check_new_update(update_id)


@update_router.get("/update/{update_id}", response_model=bool, summary="Controlla aggiornamento")
async def get_update(update_id: str, _=Depends(admin_access)):
    return updates.get_update(update_id)


@update_router.get("/update_all", response_model=bool, summary="Controlla aggiornamento")
