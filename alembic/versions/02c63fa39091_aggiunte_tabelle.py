...
def upgrade() -> None:
    ...
    op.create_table('Aule',
                    ...
                    sa.Column('posizione', sa.String(length=255), nullable=False),
                    sa.Column('materia', sa.String(length=255), nullable=False),
                    sa.Column('dettagli', sa.String(length=255), nullable=False),
    ...
    op.create_table('ScuoleDiProvenienza',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('nome', sa.String(length=255), nullable=False),
                    sa.Column('citta', sa.String(length=255), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('Orientatori',
                    ...
                    sa.Column('nome', sa.String(length=255), nullable=False),
                    sa.Column('cognome', sa.String(length=255), nullable=False),
                    sa.Column('classe', sa.String(length=255), nullable=False),
